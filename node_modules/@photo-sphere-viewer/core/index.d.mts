import { Mesh, Vector3, WebGLRenderer, Raycaster, Vector2, Intersection, Euler, Object3D, Texture, WebGLRendererParameters, SphereGeometry, MeshBasicMaterial } from 'three';
 ...
 */
type ParsedViewerConfig = Omit<ViewerConfig, 'adapter' | 'plugins' | 'defaultYaw' | 'defaultPitch' | 'moveInertia' | 'fisheye' | 'requestHeaders' | 'navbar'> & {
 ...
 */
declare function isFullscreenEnabled(elt: HTMLElement, isIphone?: boolean): boolean;
/**
 * Enters fullscreen mode
 */
declare function requestFullscreen(elt: HTMLElement, isIphone?: boolean): void;
/**
 * Exits fullscreen mode
 */
declare function exitFullscreen(isIphone?: boolean): void;
 ...
 */
declare function getXMPValue(data: string, attr: string, intVal?: boolean): number | null;
/**
 ...
 */
declare class DualFisheyeAdapter extends EquirectangularAdapter {
    static readonly id: string;
    static readonly VERSION: string;
...
declare const Cache: {
    ...
    purgeInterval: ReturnType<typeof setInterval>;
    init(): void;
